...
public class FrostDevilProj : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        if(player.dead)
        {
            modPlayer.FrostDevilProj = false;
        }
    ...
    private void UpdateFrame()
    {
        ...
        projectile.frameCounter %= 1; //Or however long you want one cycle of animation to last.
    }
}}