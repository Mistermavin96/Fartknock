...
{
public class FrostflameScythe : ModItem
    {
        ...
        {
            npc.AddBuff (44, 300, true); //first number is debuff ID, this time Frostburn. Second number is frames it lasts, in this case, 5 seconds
